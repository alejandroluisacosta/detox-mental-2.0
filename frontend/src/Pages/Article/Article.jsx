    ...
    <div className="article">
      <main className="article-content">
        ...
        <section className="step-section">
          ...
          <p>Una de las cosas que he aprendido leyendo a escritores como Tolle y oyendo a <a className='article__in-text-link' href='https://www.youtube.com/@Paramitaorg' target='_blank'>expertos de la espiritualidad</a> es que no nos conviene tomar demasiado en serio nuestros propios pensamientos.</p>
