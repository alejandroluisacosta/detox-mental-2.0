    ...
    <div className="article">
      ...
      <main className="article-content">
        ...
        <section className="recommendations-section">
          ...
          <p>La cuestión con los PQAs y con los pensamientos en general es que controlarlos es un trabajo de todos los días, por lo que la mejor manera de mantenerte en el proceso es continuar consumiendo información relacionada que promueva el mismo tipo de ideas que estás teniendo mientras lees estas líneas. Como dijo un sabio:</p>
